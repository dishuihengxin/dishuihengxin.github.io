...
![基本配置下的预览](/blog/basic-configuration-preview.zh-cn.png "基本配置下的预览")
...
![完整配置下的预览](/blog/complete-configuration-preview.zh-cn.png "完整配置下的预览")
...
![语言切换](/blog/language-switch.gif "语言切换")
